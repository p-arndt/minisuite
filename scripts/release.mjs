...
// binaries and publishes the container image. This script builds nothing itself.
//
...
// 4. Refresh Cargo.lock so the new version lands in the release commit.
//    minicloak has no dependencies, so this only re-pins minicloak itself.
